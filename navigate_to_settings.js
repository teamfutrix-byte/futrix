...
async function main() {
  ...
  console.log("Navigating to General Settings URL...");
  await targetPage.goto('https://supabase.com/dashboard/project/dsduytkikxfgiyptdwex/settings/general', {
  ...
  const screenshotPath = path.join(ARTIFACTS_DIR, 'settings_general_page.png');
